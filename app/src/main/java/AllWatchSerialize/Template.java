...
public final class Template extends Table {
    public static Template getRootAsTemplate(ByteBuffer _bb) {
        return getRootAsTemplate(_bb, new Template());
    }

    public static Template getRootAsTemplate(ByteBuffer _bb, Template obj) {
    ...
    public static void startTemplate(FlatBufferBuilder builder) {
        builder.startObject(7);
    }
    ...
    public static void addAction(FlatBufferBuilder builder, int actionOffset) {
        builder.addOffset(2, actionOffset, 0);
    }

    public static void addAttributesType(FlatBufferBuilder builder, byte attributesType) {
        builder.addByte(3, attributesType, 0);
    }
    ...
    public Template __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public Action action(Action obj) {
        int o = __offset(8);
        return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null;
    }
    ...
    public Table attributes(Table obj) {
        int o = __offset(12);
    ...
    public Template children(int j) {
        return children(new Template(), j);
    }

    public Template children(Template obj, int j) {
        int o = __offset(16);
