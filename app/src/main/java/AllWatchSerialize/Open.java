...
public final class Open extends Table {
    public static Open getRootAsOpen(ByteBuffer _bb) {
        return getRootAsOpen(_bb, new Open());
    }

    public static Open getRootAsOpen(ByteBuffer _bb, Open obj) {
    ...
    public static void startOpen(FlatBufferBuilder builder) {
        builder.startObject(1);
    }
    ...
    public Open __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
