...
public final class Application extends Table {
    public static Application getRootAsApplication(ByteBuffer _bb) {
        return getRootAsApplication(_bb, new Application());
    }

    public static Application getRootAsApplication(ByteBuffer _bb, Application obj) {
    ...
    public static void startApplication(FlatBufferBuilder builder) {
        builder.startObject(6);
    }

    public static void addReinstall(FlatBufferBuilder builder, boolean reinstall) {
        builder.addBoolean(0, reinstall, false);
    }
    ...
    public static void addIcon(FlatBufferBuilder builder, int iconOffset) {
        builder.addOffset(2, iconOffset, 0);
    }
    ...
    public static void addRequirements(FlatBufferBuilder builder, int requirementsOffset) {
        builder.addOffset(3, requirementsOffset, 0);
    }
    ...
    public static void addVoicePhrases(FlatBufferBuilder builder, int voicePhrasesOffset) {
        builder.addOffset(4, voicePhrasesOffset, 0);
    }

    public static int createVoicePhrasesVector(FlatBufferBuilder builder, int[] data) {
        builder.startVector(4, data.length, 4);
        for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]);
        return builder.endVector();
    }

    public static void startVoicePhrasesVector(FlatBufferBuilder builder, int numElems) {
        builder.startVector(4, numElems, 4);
    }

    public static void addWidget(FlatBufferBuilder builder, int widgetOffset) {
        builder.addOffset(5, widgetOffset, 0);
    }
    ...
    public Application __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public ByteBuffer requirementsInByteBuffer(ByteBuffer _bb) {
        return __vector_in_bytebuffer(_bb, 10, 2);
    }

    public String voicePhrases(int j) {
        int o = __offset(12);
        return o != 0 ? __string(__vector(o) + j * 4) : null;
    }

    public int voicePhrasesLength() {
        int o = __offset(12);
        return o != 0 ? __vector_len(o) : 0;
    }
    ...
    public Widget widget(Widget obj) {
        int o = __offset(14);
        return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null;
    }
}
