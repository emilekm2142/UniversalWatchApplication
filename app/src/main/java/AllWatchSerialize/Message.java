...
public final class Message extends Table {
    ...
    public static void addSenderName(FlatBufferBuilder builder, int senderNameOffset) {
        builder.addOffset(0, senderNameOffset, 0);
    }
    ...
    public ByteBuffer senderNameAsByteBuffer() {
        return __vector_as_bytebuffer(4, 1);
    }

    public ByteBuffer senderNameInByteBuffer(ByteBuffer _bb) {
