...
public final class ImageBackground extends Table {
    public static ImageBackground getRootAsImageBackground(ByteBuffer _bb) {
        return getRootAsImageBackground(_bb, new ImageBackground());
    }

    public static ImageBackground getRootAsImageBackground(ByteBuffer _bb, ImageBackground obj) {
    ...
    public static void startImageBackground(FlatBufferBuilder builder) {
        builder.startObject(1);
    }
    ...
    public ImageBackground __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
