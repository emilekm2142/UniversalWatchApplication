...
public final class Command extends Table {
    ...
    public static void addCommandType(FlatBufferBuilder builder, byte commandType) {
        builder.addByte(0, commandType, 0);
    }

    public static void addCommand(FlatBufferBuilder builder, int commandOffset) {
    ...
    public static void finishCommandBuffer(FlatBufferBuilder builder, int offset) {
        builder.finish(offset);
    }

    public static void finishSizePrefixedCommandBuffer(FlatBufferBuilder builder, int offset) {
    ...
    public Table command(Table obj) {
        int o = __offset(6);
